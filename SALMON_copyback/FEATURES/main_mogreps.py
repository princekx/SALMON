...
import datetime
import sys
sys.path.append('/home/users/prince.xavier/MJO/Monitoring_new/FEATURES')
...
def do_mogreps(date):
    ...
    # compute features
    status3 = reader.grid_features_3d(date, members)
...
if __name__ == '__main__':
    ...
    yesterday = datetime.datetime(2024, 10, 20)
